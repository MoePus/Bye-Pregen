...
public final class ArenaFabric implements ModInitializer {
    private static final Logger LOGGER = LoggerFactory.getLogger(ArenaFabric.class);
    ...
    private static void initializeYaLight() {
